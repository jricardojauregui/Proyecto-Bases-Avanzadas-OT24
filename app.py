...
app.add_url_rule('/creditCards', view_func=user_view_credit_cards, methods=['GET', 'POST'])
app.add_url_rule('/editCreditCards', view_func=user_manage_credit_cards, methods=['GET'])
