...
from controllers.adminController import admin_login, admin_logout, admin_edit_products, admin_edit_users, admin_edit_orders, admin_view_dash, promedio_calificacion_productos, cantidad_categorias_productos, cantidad_stock_productos, pedidos_por_mes, usuarios_por_mes, productos_estado, ganancias_por_mes
...
app.add_url_rule('/editUsers', view_func=admin_edit_users, methods=['GET', 'POST'])
app.add_url_rule('/editOrders>', view_func=admin_edit_orders, methods=['GET', 'POST'])
